...
const BLOG_URL = "https://ashmit27j.github.io/unwrtten";
				...
				<div className="flex items-center justify-between px-6 md:px-12 py-4">
					...
					<nav className="hidden md:flex items-center gap-8">
						...
						<a
							...
							target="_blank"
							rel="noreferrer"
							className="inline-flex items-center gap-1.5 text-sm uppercase tracking-widest text-muted-foreground hover:text-foreground transition-colors"
						>
							Blogs
				...
				{menuOpen && (
					...
					>
						...
						<a
							...
							target="_blank"
							rel="noreferrer"
							className="inline-flex items-center gap-2 text-2xl uppercase tracking-widest text-foreground hover:opacity-70 transition-opacity"
						>
							Blogs
